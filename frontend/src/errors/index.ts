export const Errors = {
	...
	FieldRequired: 'Поле email обязательное к заполнению',
	MinFieldLength: 'Минимальное количество символов 6',
	PasswordFormatIncorrect:
		'Пароль должен содержать минимум: одно число, один спецсимвол, одну латинскую букву в нижнем и одну в верхнем регистре',
};
